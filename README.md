# PACHE — Protocolo de Análisis Colaborativo Heurístico con Validación Empírica
...
malicia indígena, acceso libre a internet, y la disciplina de cuestionar 
sus propias conclusiones puede construir análisis estratégico de nivel 
experto sin credenciales institucionales, sin presupuesto, y en una tarde.

---

## Declaración de autoría

Este repositorio contiene documentos generados por Claude Sonnet 4.6 
(Anthropic) siguiendo instrucciones explícitas del operador humano. El 
crédito intelectual del diseño metodológico, las preguntas, y las 
decisiones analíticas corresponde al operador. Las IAs fueron instrumentos 
del método, no agentes autónomos.

De conformidad con las políticas de uso responsable de IA, ningún documento 
de este repositorio debe citarse como trabajo de autoría humana sin declarar 
que su redacción fue ejecutada por un modelo de lenguaje.

---

## IAs utilizadas

| Modelo | Sistema | Rol en el experimento |
|--------|---------|----------------------|
...
**Nota:** Este experimento no compara capacidades entre IAs. 
...
| `PACHE_paper_v2.docx` | Resumen ejecutivo formal con declaración de autoría |
...
**Paso 1 — Preparar el instrumento en contexto cero**
...
Usa Claude como visitante. Esto garantiza contexto cero absoluto.
...
Luego pega el contenido de los archivos v1, v2 y v3 en orden.
Espera a que Claude confirme que entendió el contexto.

**Paso 3 — Elige un problema nuevo o verifica el original**
...
| Modelo | IA | Score ponderado | Nota |
|--------|-----|----------------|------|
...
acceso a 24 horas más de información que el Modelo B. Este experimento 
no es una competencia entre IAs.
...
Misma estructura: datos públicos + método riguroso + tolerancia a la 
incertidumbre = hipótesis probabilista accionable.
...
*Hash final: PACHE-SCORING-FINAL-TACO-PARCIAL-20260407-MADRUGADA*
